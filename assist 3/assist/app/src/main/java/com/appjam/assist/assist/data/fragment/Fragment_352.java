...
public class Fragment_352 extends Fragment {
    Button btn_keeper;
    ...
    private void setBackNumber() {
        ...
        btn8.setText(String.valueOf(MF_list.get(4).getBacknumber()));
...
//    public void swapText(Button button){
//        if(isSelcet == false){
//            selectBtn1 = button;
//            Log.i("mytag", "button1 : " + selectBtn1.getText().toString());
//            isSelcet = true;
//        }
//        else {
//            selectBtn2 = button;
//            Log.i("mytag", "button2 : " + selectBtn2.getText().toString());
//            selectText1 = selectBtn1.getText().toString();
//            selectText2 = selectBtn2.getText().toString();
//            selectBtn2.setText(selectText1);
//            selectBtn1.setText(selectText2);
//            isSelcet = false;
//        }
//    }
