...
public class Fragment_451 extends Fragment {
    Button btn_keeper;
    ...
    private void setBackNumber() {
        ...
        btn9.setText(String.valueOf(MF_list.get(4).getBacknumber()));

        btn10.setText(String.valueOf(ATK_list.get(0).getBacknumber()));
    }
