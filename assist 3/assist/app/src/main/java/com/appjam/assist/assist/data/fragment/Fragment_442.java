...
import com.appjam.assist.assist.team.AddScheduleFragment;
...
public class Fragment_442 extends Fragment {
    Button btn_keeper;
    Button btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn10;

//    Boolean isSelcet = false;
//    Button selectBtn1, selectBtn2;
//    String selectText1, selectText2;
    ...
    private void setBackNumber() {
        ...
        btn4.setText(String.valueOf(DF_list.get(3).getBacknumber()));

        btn5.setText(String.valueOf(MF_list.get(0).getBacknumber()));
        btn6.setText(String.valueOf(MF_list.get(1).getBacknumber()));
        btn7.setText(String.valueOf(MF_list.get(2).getBacknumber()));
        btn8.setText(String.valueOf(MF_list.get(3).getBacknumber()));

        btn9.setText(String.valueOf(ATK_list.get(0).getBacknumber()));
        btn10.setText(String.valueOf(ATK_list.get(1).getBacknumber()));
    }
